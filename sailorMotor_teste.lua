--Teste com corte co motor pelo controle
...
function sailormotor()
    ...
    if vehicle:get_mode() == 3 then --verifica se está em auto
    ...
    return sailormotor, 100
end
gcs:send_text(6, "sailorMotor.lua is running")
return sailormotor(), 10000
